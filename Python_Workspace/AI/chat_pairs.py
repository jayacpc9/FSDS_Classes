...
pairs = [
    ...
    [r"(.*) your name ?", ["My name is Jaya, but you can just call me robot and I'm a chatbot .",]],
    ...
    [r"(.*)created(.*)", ["Jaya created me using Python's NLTK library ", "top secret ;)",]],
    [r"(.*) (location|city|from|where) ?(.*)", ['hyderabad, India',]],
